...
const getFriendlySupabaseErrorMessage = (error, context = 'general') => {
  if (!isNetworkOrDnsError(error)) {
    return error?.message || 'OcurriÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³ un problema inesperado al conectar con Supabase.';
  }

  if (context === 'login') {
    return 'No se pudo conectar con Supabase desde esta red mÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³vil. Verifica tu conexiÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³n o intenta con otra red para iniciar sesiÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³n.';
  }

  if (context === 'dashboard') {
    return 'No se pudo conectar con Supabase desde esta red mÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³vil. No pude actualizar los datos operativos en este momento.';
  }

  return 'No se pudo conectar con Supabase desde esta red mÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³vil. Intenta nuevamente cuando la conexiÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³n estÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â© estable.';
};
...
function SystemView({
  ...
  { roleName: 'admin', description: 'Administra la barberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a y su configuraciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n' },
  { roleName: 'cashier', description: 'Caja / recepciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n' },
      ];
  ...
  const handleSubmitOnboarding = async (event) => {
    ...
    if (!onboarding.name.trim()) {
      notify('Ingresa el nombre de la barberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a para completar el onboarding.', 'warning');
      return;
    }
  ...
  const handleSubmitNewUser = async (event) => {
    ...
    if (newUser.password.trim().length < PASSWORD_MIN_LENGTH) {
      notify(`Define una contraseÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a temporal de al menos ${PASSWORD_MIN_LENGTH} caracteres.`, 'warning');
      return;
    }
    ...
    if (!resolvedBarbershopId) {
      notify(
        isSuperAdmin
          ? 'Selecciona la barberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a a la que pertenecerÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½ este usuario.'
          : 'Tu cuenta de administrador todavÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a no estÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½ vinculada a una barberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a.',
        'warning',
      );
      return;
    }
  ...
  const handleSubmitBranch = async (event) => {
    ...
    if (!resolvedBarbershopId || !branchForm.name.trim()) {
      notify('Completa el nombre de la sucursal y la barberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a correspondiente.', 'warning');
      return;
    }
    ...
    <div className="p-4 md:p-10 space-y-6 md:space-y-8 animate-in fade-in text-white no-print">
      {isSuperAdmin && (
        <section className="flex flex-wrap gap-3">
          {[{ id: 'barbershops', label: 'BarberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½as' }, { id: 'branches', label: 'Sucursales' }, { id: 'users', label: 'Usuarios' }].map((item) => (
            <button
              key={item.id}
            ...
            <form onSubmit={handleSubmitOnboarding}>
              <div className="px-8 py-7 border-b border-white/5 flex items-center justify-between gap-6">
                <div className="min-w-0">
                  <p className="text-[10px] font-black uppercase tracking-[0.22em] text-indigo-300">ConfiguraciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n comercial</p>
                  <h3 className="mt-3 text-[2rem] font-black uppercase italic tracking-tighter text-white leading-none">
                    Nueva barberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a
                  </h3>
                </div>
              </div>
              ...
              <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  ...
                  <input
                    ...
                    placeholder="Ej. BarberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a Central"
                ...
                <div className="space-y-3">
                  <label className="text-[10px] font-black uppercase tracking-[0.22em] text-slate-500">Correo del dueÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½o</label>
                  <input
                ...
                <div className="space-y-3">
                  <label className="text-[10px] font-black uppercase tracking-[0.22em] text-slate-500">TelÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½fono</label>
                  <input
                ...
                <div className="space-y-3">
                  ...
                  <select
                    ...
                    className="w-full bg-black border border-slate-800 rounded-[1.4rem] px-6 py-4 text-sm font-bold text-white outline-none focus:border-indigo-500 italic"
                  >
                    <option value="">Asignar despuÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½s</option>
              ...
              <div className="px-8 pb-8 flex flex-col sm:flex-row gap-3">
                ...
                >
                  ...
                  Crear barberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a
                </button>
                <button
                  type="button"
                  onClick={() => setShowCreateBarbershop(false)}
              ...
              <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                {isSuperAdmin && (
                  <div className="space-y-3 md:col-span-2">
                    <label className="text-[10px] font-black uppercase tracking-[0.22em] text-slate-500">BarberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a</label>
                    <select
                      value={effectiveBranchFormBarbershopId}
                      onChange={(e) => setBranchForm((prev) => ({ ...prev, barbershopId: e.target.value }))}
                      className="w-full bg-black border border-slate-800 rounded-[1.4rem] px-6 py-4 text-sm font-bold text-white outline-none focus:border-indigo-500 italic"
                    >
                      <option value="">Selecciona una barberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a</option>
                ...
                <div className="space-y-3">
                  <label className="text-[10px] font-black uppercase tracking-[0.22em] text-slate-500">CÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½digo interno</label>
                  <input
                ...
                <div className="space-y-3">
                  <label className="text-[10px] font-black uppercase tracking-[0.22em] text-slate-500">DirecciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n</label>
                  <input
          ...
          <div className="px-5 md:px-8 py-6 md:py-7 border-b border-slate-800 bg-black/40">
            <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-5">
              <div>
                ...
                <h4 className="mt-3 text-2xl md:text-3xl font-black uppercase italic tracking-tighter text-white">BarberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½as registradas</h4>
              </div>
              ...
              <div className="w-full xl:w-auto flex flex-col sm:flex-row gap-3">
                <div className="rounded-[1.6rem] border border-white/5 bg-slate-950 px-5 py-4 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">
                  {barbershops.length} barberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½as
                </div>
                <button
                  type="button"
          ...
          <div className="p-4 md:p-8">
            {barbershops.length > 0 ? (
              <>
                    ...
                    <div key={shop.id} className="rounded-[2rem] border border-white/5 bg-black/25 p-5">
                      ...
                      <div className="mt-4 grid grid-cols-1 gap-3 text-sm">
                        ...
                        <div>
                          ...
                          <p className="mt-1 font-bold text-slate-300 break-all">{shop.ownerEmail || 'Sin correo del dueÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½o'}</p>
                        </div>
                ...
                <div className="min-w-[980px]">
                  <div className="grid grid-cols-[minmax(220px,1.2fr)_160px_minmax(260px,1.2fr)_140px_140px] gap-4 px-6 py-5 border-b border-white/5 text-[9px] font-black uppercase tracking-[0.24em] text-slate-500">
                    <span>BarberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a</span>
                    <span>Ciudad</span>
                      ...
                      >
                        ...
                        <div className="min-w-0">
                          <p className="text-sm font-bold text-slate-300 break-all">
                            {shop.ownerEmail || 'Sin correo del dueÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½o'}
                          </p>
                          {shop.phone && (
              ...
              <div className="rounded-[2.4rem] border border-white/5 bg-black/20 px-6 py-16 text-center">
                <p className="text-[11px] font-black uppercase tracking-[0.22em] text-slate-500">TodavÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a no hay barberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½as registradas</p>
              </div>
            )}
          </div>
        </section>
        ...
        <section className="rounded-[3rem] border border-slate-800 bg-slate-900 shadow-2xl overflow-hidden">
              ...
              <div className="w-full xl:w-auto flex flex-col sm:flex-row gap-3">
                {isSuperAdmin && (
                  <div className="w-full sm:w-[260px]">
                    ...
                    >
                      <option value="all">Todas las barberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½as</option>
                      {barbershops.map((shop) => (
                        <option key={shop.id} value={shop.id}>{shop.name}</option>
                      ))}
                    </select>
          ...
          <div className="p-4 md:p-8">
            {filteredBranches.length > 0 ? (
              <>
                <div className="grid gap-4 md:hidden">
                  {filteredBranches.map((branch) => (
                    <div key={branch.id} className="rounded-[2rem] border border-white/5 bg-black/25 p-5">
                      ...
                      <div className="mt-4 grid grid-cols-1 gap-3 text-sm">
                        <div>
                          <p className="text-[9px] font-black uppercase tracking-[0.18em] text-slate-500">BarberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a</p>
                          <p className="mt-1 font-bold text-slate-300 break-words">{branch.barbershopName || currentBarbershop?.name || 'Sin barberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a'}</p>
                        </div>
                        <div className="grid grid-cols-2 gap-3">
                          <div>
                            <p className="text-[9px] font-black uppercase tracking-[0.18em] text-slate-500">CÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½digo</p>
                            <p className="mt-1 font-bold text-slate-300">{branch.code || 'Sin cÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½digo'}</p>
                          </div>
                          <div>
                            <p className="text-[9px] font-black uppercase tracking-[0.18em] text-slate-500">Ciudad</p>
                        ...
                        <div>
                          <p className="text-[9px] font-black uppercase tracking-[0.18em] text-slate-500">DirecciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n</p>
                          <p className="mt-1 font-bold text-slate-300 break-words">{branch.address || 'Sin direcciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n'}</p>
                        </div>
                        <button
                          type="button"
                ...
                <div className="min-w-[1120px]">
                  <div className="grid grid-cols-[minmax(220px,1.1fr)_minmax(220px,1fr)_140px_150px_minmax(260px,1.3fr)_130px] gap-4 px-6 py-5 border-b border-white/5 text-[9px] font-black uppercase tracking-[0.24em] text-slate-500">
                    <span>Sucursal</span>
                    <span>BarberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a</span>
                    <span>CÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½digo</span>
                    <span>Ciudad</span>
                    <span>DirecciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n</span>
                    <span>Acciones</span>
                  </div>
                  ...
                  <div className="divide-y divide-white/5">
                    {filteredBranches.map((branch) => (
                      ...
                      >
                        ...
                        <div className="min-w-0">
                          <p className="text-sm font-bold text-slate-300 break-all">
                            {branch.barbershopName || currentBarbershop?.name || 'Sin barberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a'}
                          </p>
                        </div>
                        <div>
                          <p className="text-sm font-bold text-slate-300">
                            {branch.code || 'Sin cÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½digo'}
                          </p>
                        </div>
                        <div>
                          <p className="text-sm font-bold text-slate-300">
                        ...
                        <div className="min-w-0">
                          <p className="text-sm font-bold text-slate-300 break-all">
                            {branch.address || 'Sin direcciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n'}
                          </p>
                        </div>
                        <div>
                          <button
              ...
              <div className="rounded-[2.4rem] border border-white/5 bg-black/20 px-6 py-16 text-center">
                <p className="text-[11px] font-black uppercase tracking-[0.22em] text-slate-500">TodavÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a no hay sucursales registradas</p>
              </div>
            )}
          </div>
        </section>
            ...
            <div>
              ...
              <div className="w-full xl:w-[360px] relative">
                ...
                <input
                  ...
                  placeholder="Buscar por nombre, correo, rol, barberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a o sucursal"
        ...
        <div className="p-4 md:p-8 space-y-5">
          {canCreateUsers && showCreateUser && (
            <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/80 p-4 backdrop-blur-md animate-in fade-in duration-300">
              <div className="w-full max-w-4xl bg-slate-950 border border-white/10 rounded-[3rem] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.8)] animate-in zoom-in-95 duration-300 relative text-white max-h-[88vh] overflow-y-auto custom-scrollbar">
                ...
                <form onSubmit={handleSubmitNewUser}>
                  ...
                  <div className="p-8 grid grid-cols-1 gap-6">
                    ...
                    <div className="space-y-3">
                      <label className="text-[10px] font-black uppercase tracking-[0.22em] text-slate-500">ContraseÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a temporal</label>
                      <input
                        type="password"
                        value={newUser.password}
                        onChange={(e) => setNewUser((prev) => ({ ...prev, password: e.target.value }))}
                        placeholder={`MÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½nimo ${PASSWORD_MIN_LENGTH} caracteres`}
                        className="w-full bg-black border border-slate-800 rounded-[1.4rem] px-6 py-4 text-sm font-bold text-white outline-none focus:border-indigo-500 italic"
                      />
                    </div>
              ...
              Guardar configuraciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n de acceso
                    </button>
                  </div>
                </form>
              </div>
...
{users.length > 0 && (
            ...
            <div className="grid gap-4 md:hidden">
              {users.map((user) => {
                ...
                const scopeLabel = isSuperAdmin
                  ? [user.barbershopName, user.branchName].filter(Boolean).join(' ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½ ')
                  : (user.branchName || '');
                return (
                  <div key={user.id} className="rounded-[2rem] border border-white/5 bg-black/25 p-5">
                    ...
                    {canResetPasswordForUser(user) && (
                      ...
                      >
                        Restablecer contraseÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a
                      </button>
                    )}
                    <div className="mt-4 flex items-center justify-between gap-3">
                      ...
                      {canEditUser(user) ? (
                        ...
                        <span className="text-[10px] font-black uppercase tracking-[0.18em] text-slate-600">Sin ediciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n</span>
                      )}
                    </div>
                  </div>
                );
                      ...
                      <div className="flex items-center">
                        {canEditUser(user) ? (
                          ...
                          <span className="text-[10px] font-black uppercase tracking-[0.18em] text-slate-600">
                            Sin ediciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n
                          </span>
                        )}
                      </div>
                    </div>
          ...
          {!users.length && (
            ...
            No encontramos usuarios con ese criterio de bÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½squeda
              </p>
            </div>
          )}
          ...
          {resetPasswordTarget && (
            <Suspense fallback={accessUiFallback}>
                <PasswordActionModal
              title="ContraseÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a temporal"
              subtitle={resetPasswordTarget.fullName || resetPasswordTarget.email}
              submitLabel="Guardar contraseÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a temporal"
              busy={resettingPasswordUserId === resetPasswordTarget.id}
                  ...
                  onSubmit={async ({ nextPassword }) => {
                    ...
                    if (success) {
                      notify(`ContraseÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a temporal actualizada para ${resetPasswordTarget.email}.`, 'success');
                      setResetPasswordTarget(null);
                      return true;
                    }
                    return false;
                  }}
                  nextLabel="Nueva contraseÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a temporal"
                  nextPlaceholder="MÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½nimo 6 caracteres"
                  initialNextPassword=""
...
export default function App() {
  ...
  const [services, setServices] = useState(() => {
    ...
    return [
      { id: '1', name: 'Corte ClÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½sico', price: 250, category: 'Cortes' },
  ...
  const confirmAction = (options) => new Promise((resolve) => {
    setConfirmState({
      title: options?.title || 'Confirmar acciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n',
  ...
  useEffect(() => {
    ...
    const authBootstrapTimeout = window.setTimeout(() => {
      ...
      console.error('La restauraciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n de sesiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n tardÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½ demasiado y se cancelÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½ para mostrar el login.');
      setSession(null);
      setAuthError('La sesiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n guardada tardÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½ demasiado en responder. Ingresa de nuevo.');
      setAuthLoading(false);
    }, 6000);
    ...
    supabase.auth.getSession()
      .then(({ data, error }) => {
        ...
        if (error) {
          console.error('No se pudo restaurar la sesiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n:', error);
          setAuthError('No pude restaurar la sesiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n guardada.');
        }
      ...
      .catch((error) => {
        if (!mounted || authBootstrapTimedOut) return;
        window.clearTimeout(authBootstrapTimeout);
        console.error('FallÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½ la verificaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n de sesiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n:', error);
        setSession(null);
        setAuthError('No pude verificar la sesiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n guardada. Ingresa de nuevo.');
        setAuthLoading(false);
      });
    ...
    const bootstrap = async () => {
      try {
        ...
        if (!ignore) {
          ...
          notify(
            `${friendlyErrorMessage}\n\nMostrÃƒÂ© el estado vacÃƒÂ­o para evitar que se mezclen datos anteriores con informaciÃƒÂ³n incompleta.`,
            'error',
          );
        }
      } finally {
    ...
    const loadClientDirectoryData = async () => {
      try {
        ...
        if (!ignore) {
          ...
          setClientDirectoryLoaded(true);
          notify(
            'No pude cargar el directorio de clientes. DejÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½ la vista vacÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a para evitar mÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½tricas parciales o datos engaÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½osos.',
            'error',
          );
        }
      }
  ...
  const handleChangeOwnPassword = async ({ nextPassword }) => {
    ...
    try {
      ...
      notify('Tu contraseÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a se actualizÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½ correctamente.', 'success');
      setShowSelfPasswordModal(false);
      return true;
    } catch (error) {
      handleSyncError(error, 'No pude actualizar tu contraseÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a.');
      return false;
    } finally {
  ...
  const handleUpdateUserProfile = async (user, payload) => {
    ...
    if (!isSuperAdmin) {
      if (currentRole !== 'cashier' || String(user.barbershopId || '') !== String(currentBarbershopId || '')) {
        notify('Solo puedes editar usuarios Caja de tu propia barberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a.', 'warning');
        return false;
      }
    }

    if (!isSuperAdmin && nextRole !== 'cashier') {
      notify('Un administrador de barberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a solo puede asignar el rol Caja.', 'warning');
      return false;
    }
  ...
  const handleCreateSystemUser = async (payload) => {
    ...
    if (!isSuperAdmin && payload.roleName !== 'cashier') {
      notify('Un administrador de barberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a solo puede crear usuarios de caja.', 'warning');
      return null;
    }

    if (!isSuperAdmin && !currentBarbershopId) {
      notify('Tu usuario administrador no tiene una barberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a asignada.', 'error');
      return null;
    }
  ...
  const handleResetUserPassword = async (user, password) => {
    if (!isAdmin) {
      notify('Solo un administrador puede restablecer contraseÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½as.', 'warning');
      return false;
    }

    if (!isSuperAdmin && getPrimaryRole(user) !== 'cashier') {
      notify('Un administrador de barberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a solo puede restablecer contraseÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½as de usuarios Caja.', 'warning');
      return false;
    }
    ...
    try {
      ...
      throw new Error(error?.message || 'No pude restablecer la contraseÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a de este usuario.');
    } finally {
  ...
  const handleCreateBranch = async (payload) => {
    ...
    try {
      ...
      if (!resolvedBarbershopId) {
        notify('Selecciona una barberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a para crear la sucursal.', 'warning');
        return null;
      }
    ...
    const checkReservationAlerts = async () => {
      ...
      for (const appointment of pendingReservations) {
        ...
        if (
          ...
          notify(
            `La cita de "${clientName}" ya se venciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½\n\nSucursal / barbero: ${barberName}\nHora reservada: ${appointment.time}\n\nLa reserva se marcÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½ como cita perdida.`,
            'reservation-expired',
          );
  ...
  if (authLoading) {
    return (
      <div className="h-screen flex flex-col items-center justify-center bg-black gap-4 text-white">
        ...
        <span className="text-[10px] font-black uppercase tracking-widest italic">Verificando sesiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n...</span>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-black text-white flex items-center justify-center p-6">
        ...
        <div className="w-full max-w-2xl rounded-[2rem] border border-rose-500/20 bg-slate-950 p-8 shadow-[0_20px_60px_rgba(0,0,0,0.6)]">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-black uppercase italic tracking-tighter">ConfiguraciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n requerida</h1>
              <p className="mt-2 text-sm text-slate-300">
                Esta instalaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n estÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½ en modo producciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n y requiere una conexiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n vÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½lida a Supabase.
              </p>
            </div>
          </div>
          ...
          <p className="mt-6 text-sm text-slate-400 leading-relaxed">
            La aplicaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n fue bloqueada para evitar que opere con datos locales aislados en cada navegador. Configura las variables de entorno del servidor y vuelve a desplegar.
          </p>
        </div>
      </div>
    );
      ...
      <div className="min-h-screen bg-black text-white flex items-center justify-center p-6">
        ...
        <div className="w-full max-w-2xl rounded-[2rem] border border-amber-500/20 bg-slate-950 p-8 shadow-[0_20px_60px_rgba(0,0,0,0.6)]">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-black uppercase italic tracking-tighter">ConfiguraciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n pendiente</h1>
              <p className="mt-2 text-sm text-slate-300">
                No hay una conexiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n vÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½lida a Supabase y el modo local estÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½ desactivado para evitar datos de prueba confusos.
              </p>
            </div>
          </div>
          <div className="rounded-[1.5rem] border border-white/10 bg-black/40 p-5 space-y-3">
            <p className="text-[10px] font-black uppercase tracking-widest text-slate-500">CÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½mo continuar</p>
            ...
            <p className="text-sm text-slate-500">Para sembrar datos demo en ese modo, agrega tambiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n `VITE_SEED_LOCAL_MODE=true`.</p>
          </div>
        </div>
      </div>
    );
  ...
  const handleAgendaAppointmentClick = async (appointment) => {
    ...
    if (appointment.status === 'Cita Perdida') {
      notify('Esta cita ya estÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½ marcada como perdida.', 'info');
      return;
    }
    ...
    if (appointment.status === 'Confirmada') {
      if (normalizedDate && normalizedDate < today) {
        const shouldMarkLost = await confirmAction({
          title: 'Cita vencida',
          message: 'Esta cita quedÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½ en un dÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a anterior y nunca se iniciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½. ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½Deseas marcarla como cita perdida?',
      ...
      const shouldCheckIn = await confirmAction({
        ...
        message: 'Esta cita todavÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a no ha iniciado. ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½Deseas marcar la llegada del cliente para pasarla a espera?',
  ...
  const handleSaveAppointment = async (aptData, clientData) => {
    ...
    if (clientData.isNew) {
      ...
      if (duplicateClient) {
        notify(`Este nÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½mero ya pertenece a ${duplicateClient.name}. Selecciona ese cliente existente.`, 'warning');
        return;
      }
  ...
  const handleSaveClient = async (clientData) => {
    ...
    if (duplicateClient) {
      notify(`Este nÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½mero ya pertenece a ${duplicateClient.name}.`, 'warning');
      return;
    }
  ...
  const handleDeleteClient = async (id) => {
    ...
    const confirmed = await confirmAction({
      ...
      message: 'ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½Eliminar cliente permanentemente?',
  ...
  const handleDeleteBarber = async (id) => {
    ...
    const confirmed = await confirmAction({
      ...
      message: 'ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½Eliminar barbero permanentemente?',
      confirmLabel: 'Eliminar',
    });
  ...
  const handleRegisterPosSale = async (saleDraft) => {
    ...
    if (!currentBarbershopId) {
      notify('No se puede registrar la venta porque no hay una barberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a activa.', 'error');
      return null;
    }
    if (!currentBranchId) {
    ...
    const saleRecord = {
      ...
      notes: saleDraft?.promotion?.name
        ? `PromociÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n aplicada: ${saleDraft.promotion.name}`
        : (saleDraft?.manualDiscount
  ...
  return (
    ...
    <div className="mobile-simplify-shell flex h-dvh min-h-dvh bg-black text-white font-sans overflow-hidden">
      ...
      {mobileSidebarOpen && (
        <button
          type="button"
          aria-label="Cerrar menÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½"
      ...
      <aside className={`mobile-sidebar fixed inset-y-0 left-0 z-40 flex w-[10.75rem] max-w-[68vw] flex-col border-r border-slate-900 bg-slate-950 no-print overflow-hidden transition-all duration-300 lg:static lg:max-w-none lg:translate-x-0 ${sidebarCollapsed ? 'lg:w-0 lg:min-w-0 lg:opacity-0 lg:pointer-events-none lg:border-r-transparent' : 'lg:w-64 lg:opacity-100'} ${mobileSidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}>
        <div className={`mobile-sidebar-brand shrink-0 p-3 lg:p-8 flex items-start ${sidebarCollapsed ? 'lg:justify-center lg:px-4' : 'gap-2.5 lg:gap-3'}`}>
          ...
          <button
            ...
            aria-label="Cerrar menÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½ lateral"
          >
            <X size={16} />
          </button>
        </div>
        ...
        <div className={`mobile-sidebar-footer shrink-0 mobile-safe-bottom px-2 lg:px-4 py-3 lg:py-4 border-t border-slate-900 ${sidebarCollapsed ? 'lg:px-3' : ''}`}>
          {isSuperAdmin && availableBarbershops.length > 0 && sidebarCollapsed && (
            <button
              ...
              title={currentBarbershop?.name ? `Cambiar barberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a actual: ${currentBarbershop.name}` : 'Cambiar barberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a'}
            >
              <Crown size={16} />
            </button>
          )}
          {(currentBarbershop?.name || currentBranch?.name || (isSuperAdmin && availableBarbershops.length > 0)) && !sidebarCollapsed && (
            <div className="mobile-sidebar-tenant-panel mb-4 rounded-2xl border border-white/10 bg-slate-900/70 px-4 py-3 space-y-2">
              {isSuperAdmin && availableBarbershops.length > 0 ? (
                <div className="min-w-0">
                  <div className="flex items-center justify-between gap-3">
                    <div>
                      ...
                      <p className="mt-1 text-[10px] font-black uppercase tracking-[0.12em] text-indigo-300">BarberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a</p>
                    </div>
                ...
                <div className="min-w-0">
                  <p className="text-[9px] font-black tracking-[0.18em] uppercase text-slate-500">BarberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a</p>
          ...
          <div className="mobile-sidebar-actions">
            {hasSupabaseConfig && session?.user && (
              <button
                ...
                title={sidebarCollapsed ? 'Cambiar contraseÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a' : undefined}
              >
                {passwordBusy ? <Loader2 size={14} className="animate-spin" /> : <ShieldCheck size={14} />}
                <span className={sidebarCollapsed ? 'lg:hidden' : ''}>Cambiar contraseÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a</span>
              </button>
            )}
            {hasSupabaseConfig && (
              <button
                ...
                title={sidebarCollapsed ? 'Cerrar sesiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n' : undefined}
              >
                {authBusy ? <Loader2 size={14} className="animate-spin" /> : <X size={14} />}
                <span className={sidebarCollapsed ? 'lg:hidden' : ''}>Cerrar SesiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n</span>
              </button>
            )}
          </div>
        </div>
        ...
        <header className="bg-black border-b border-slate-900 px-3 md:px-8 py-2.5 md:py-4 flex flex-col gap-2.5 md:flex-row md:items-center md:justify-between z-20 no-print">
          <div className="flex w-full md:w-auto items-center gap-3 min-w-0">
            <button
              ...
              aria-label="Abrir menÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½ lateral"
            >
              <Menu size={18} />
            </button>
            <button
              ...
              aria-label={sidebarCollapsed ? 'Expandir menÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½ lateral' : 'Colapsar menÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½ lateral'}
            >
              <Menu size={18} />
            </button>
      ...
      {showSelfPasswordModal && (
        <Suspense fallback={accessUiFallback}>
        <PasswordActionModal
          title={session?.user?.user_metadata?.must_change_password ? 'Actualiza tu contraseÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a' : 'Cambiar contraseÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a'}
          subtitle={session?.user?.user_metadata?.must_change_password ? 'Cambio obligatorio al primer acceso' : 'Mi cuenta'}
          submitLabel="Actualizar contraseÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a"
          busy={passwordBusy}
          onClose={() => {
          ...
          nextLabel="Nueva contraseÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a"
          nextPlaceholder="MÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½nimo 6 caracteres"
    ...
    <div className="p-4 md:p-8 h-full flex flex-col gap-4 md:gap-6 bg-slate-950 no-print">
      <div className="flex flex-col lg:flex-row justify-between lg:items-center gap-4 bg-black border border-slate-800 p-4 md:p-6 rounded-[2rem] md:rounded-[2.5rem] shadow-2xl text-white">
        ...
        <div className="text-center lg:text-right">
          <p className="mobile-simplify-subtitle text-[10px] font-black uppercase tracking-[0.3em] text-indigo-500 italic mb-2 leading-none">Agenda de BarberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a</p>
                    ...
                    <div key={`${h}-${b.id}`} onClick={() => !apt ? onSlotClick(h, b.id) : onAptClick(apt)} className={`p-2 border-r border-slate-900 last:border-r-0 relative transition-all flex items-stretch group/cell ${!apt ? 'cursor-pointer hover:bg-indigo-500/[0.05]' : ''}`}>
                      {apt ? (
                        <div className={`w-full ${statusStyles} rounded-2xl p-4 text-[10px] font-black uppercase italic shadow-2xl flex flex-col justify-between animate-in zoom-in-95 border-l-4 transition-all hover:scale-[1.02] cursor-pointer text-white`}>
                          ...
                          {apt.status === 'Cita Perdida' ? 'NO LLEGÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½' : getAgendaServiceLabel(apt.service)}
                            </span>
  ...
  return (
    <div className="p-4 md:p-10 space-y-6 md:space-y-12 h-full animate-in fade-in text-white no-print">
      <div className="flex flex-col lg:flex-row justify-between lg:items-center gap-4 text-white">
        <div>
          <h3 className="text-2xl sm:text-3xl md:text-4xl font-black italic uppercase tracking-tighter leading-none text-white">MenÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½ de Servicios</h3>
          <p className="mobile-simplify-subtitle text-[10px] text-indigo-400 font-black uppercase mt-2 italic tracking-[0.2em] leading-none">GestiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n Maestra de CatÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½logo</p>
        </div>
        <button onClick={() => onAdd(activeCategory)} className="w-full sm:w-auto bg-indigo-600 hover:bg-indigo-500 text-white px-8 md:px-10 py-4 md:py-5 rounded-[2rem] font-black text-[10px] md:text-xs uppercase italic shadow-2xl shadow-indigo-600/40 flex items-center justify-center gap-3 transition-all active:scale-95 group text-white"><Plus size={20} className="group-hover:rotate-90 transition-transform" /> {activeCategory === 'Promocion' ? 'Nueva PromociÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n' : 'Nuevo Servicio'}</button>
      </div>
                ...
                <div className="mt-5 space-y-3">
                  <div className="flex flex-wrap gap-2">
                    <span className="inline-flex items-center rounded-full border border-emerald-400/30 bg-emerald-500/10 px-3 py-1 text-[9px] font-black uppercase tracking-widest text-emerald-300">
                      {'PromociÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n general'}
                    </span>
                  ...
                  <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-slate-500">
                    AplicaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n manual al momento de cobrar
                  </p>
                </div>
              )}
            </div>
...
function BarbersView({ barbers, appointments, branches, currentBarbershopId, currentBranchId, canChooseBranch, onSave, onDelete, onGoToNomina }) {
  ...
  const submit = async () => {
    ...
    if (getPhoneDigits(form.phone).length > 0 && !isValidPhoneNumber(form.phone)) {
      notify('El telÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½fono mÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½vil debe tener exactamente 8 dÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½gitos.', 'warning');
      return;
    }
    if (barberHasBasePay(form.paymentMode) && parseSalary(form.salary) <= 0) {
      notify('Debes ingresar un salario base vÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½lido para esta modalidad.', 'warning');
      return;
    }
    if (barberHasCommissionPay(form.paymentMode)) {
      const commissionRate = parseSalary(form.commission);
      if (commissionRate <= 0) {
        notify('Debes ingresar un porcentaje de comisiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n vÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½lido para esta modalidad.', 'warning');
        return;
      }
      if (commissionRate > 100) {
        notify('La comisiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n no puede ser mayor al 100%.', 'warning');
        return;
      }
    }
    const savedBarber = {
  ...
  const staffMetrics = useMemo(() => {
    ...
    return {
      ...
      avgCommissionCaption: commissionBarbers.length
        ? `Promedio pendiente para ${commissionBarbers.length} por comisiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n`
        : 'No hay staff por comisiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n',
    ...
    <div className="p-10 space-y-8 animate-in fade-in text-white no-print">
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 text-white">
        <div>
          ...
          <p className="text-[10px] text-indigo-400 font-black uppercase tracking-widest mt-1 italic leading-none">Administre el staff, salarios y liquidaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n de comisiones</p>
        </div>
        <div className="flex gap-4">
          ...
          >
            <Wallet size={16} /> Pagar NÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½mina
          </button>
        ...
        <div className="bg-slate-900 p-6 rounded-[2rem] border border-slate-800 shadow-lg hover:shadow-emerald-500/40 transition-all text-white">
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="inline-flex rounded-2xl border border-white/10 bg-black/30 p-1">
              ...
              >
                ComisiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n
              </button>
            </div>
          </div>
        ...
        <div className="flex justify-between items-center mb-5 text-white">
          ...
          <div className="relative text-white w-full max-w-xs">
            <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500" size={16} />
                <input value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Buscar por nombre, cÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½dula o telÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½fono" className="pl-10 pr-4 py-3 w-full rounded-xl bg-black border border-slate-800 text-sm text-white outline-none focus:border-indigo-500" />
          </div>
        </div>
              ...
              <div key={b.id} onClick={() => openEdit(b)} className={`bg-gradient-to-br from-slate-900 to-slate-800 border ${b.color || 'border-slate-700'} rounded-[2.5rem] p-6 shadow-lg hover:shadow-indigo-500/30 transition-all relative overflow-hidden group cursor-pointer flex flex-col justify-between h-full text-white`}>
                ...
                <div className="relative z-10 text-white">
                  ...
                  <div className="space-y-3 py-4 border-y border-white/5 mb-4 text-white">
                    ...
                    <div className="flex justify-between items-center text-white">
                        <span className="text-[9px] font-black text-slate-500 uppercase tracking-widest">CÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½dula</span>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4 backdrop-blur-md animate-in fade-in duration-300 text-white">
          <div className="w-full max-w-[70rem] max-h-[92vh] bg-slate-950 border border-white/10 rounded-[2.4rem] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.8)] animate-in zoom-in-95 duration-300 flex flex-col md:flex-row relative text-white">
            ...
            <div className={`w-full md:w-[30%] p-7 flex flex-col items-center justify-start border-b md:border-b-0 md:border-r border-white/5 bg-gradient-to-b from-white/5 to-transparent relative overflow-y-auto custom-scrollbar text-white`}>
              ...
              <p className="text-[9px] font-black text-white/40 uppercase tracking-[0.16em] mb-4 italic">CÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½dula: {form.cedula || 'Sin registrar'}</p>
            ...
            <div className="flex-1 p-7 overflow-y-auto custom-scrollbar flex flex-col text-white">
              <div className="flex items-center gap-4 mb-6 text-white">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-white/30 font-black uppercase tracking-widest mt-1 leading-none">InformaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n de nÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½mina y contacto</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 text-white">
                <div className="space-y-2 text-white">
                  ...
                  <div className="relative group text-white">
                    ...
                    <input value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} placeholder="Ej. Juan PÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½rez" className="w-full bg-black border border-white/10 rounded-2xl pl-12 pr-6 py-3.5 text-sm font-bold text-white outline-none focus:border-indigo-500 focus:bg-white/[0.07] transition-all" />
                  </div>
                </div>
                <div className="space-y-2 text-white">
                  ...
                  <div className="relative group text-white">
                    <User className="absolute left-5 top-1/2 -translate-y-1/2 text-white/20 group-focus-within:text-indigo-400 transition-colors" size={16}/>
                    <input value={form.fullName} onChange={(e) => setForm({ ...form, fullName: e.target.value })} placeholder="Ej. Juan Carlos PÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½rez LÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½pez" className="w-full bg-black border border-white/10 rounded-2xl pl-12 pr-6 py-3.5 text-sm font-bold text-white outline-none focus:border-indigo-500 focus:bg-white/[0.07] transition-all" />
                  </div>
                </div>
                <div className="space-y-2 text-white">
                  <label className="text-[9px] font-black text-white/30 uppercase tracking-[0.2em] ml-2 italic leading-none">TelÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½fono mÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½vil</label>
                  <div className="relative group text-white">
                ...
                <div className="space-y-2 text-white">
                  <label className="text-[9px] font-black text-white/30 uppercase tracking-[0.2em] ml-2 italic leading-none">CÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½dula</label>
                  <div className="relative group text-white">
                ...
                <div className="space-y-2 text-white">
                  ...
                  <div className="space-y-2 text-white">
                    <label className="text-[9px] font-black text-white/30 uppercase tracking-[0.2em] ml-2 italic leading-none">ComisiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n (%)</label>
                    <div className="relative group text-white">
  ...
  const indicatorCards = [
    {
      ...
      helper: `Base C$ ${summary.base.toLocaleString()} + comisiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n C$ ${summary.comission.toLocaleString()}`,
      icon: Wallet,
    ...
    },
    {
      ...
      helper: summary.pendingServices > 0 ? 'Citas finalizadas aÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n no liquidadas' : 'Todo el corte pendiente ya estÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½ bajo control',
      icon: Scissors,
    ...
    <div className="p-4 md:p-10 space-y-6 md:space-y-8 animate-in fade-in text-white no-print">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
          <h3 className="text-3xl font-black uppercase italic tracking-tighter leading-none text-white">LiquidaciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n de NÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½mina</h3>
        ...
        <table className="min-w-[980px] w-full text-left">
          <thead className="bg-black/80 border-b border-slate-800 font-black uppercase text-[10px] text-slate-500 tracking-[0.2em] italic">
            <tr>
              ...
              <th className="px-10 py-7 text-right">AcciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n</th>
            </tr>
          </thead>
  ...
  return (
    <div className="px-3 py-4 md:p-12 space-y-6 md:space-y-12 h-full animate-in fade-in pb-24 md:pb-32 text-white no-print">
      <div className="flex flex-col xl:flex-row xl:justify-between xl:items-end gap-4 md:gap-5 text-white">
        <div><h3 className="text-2xl md:text-4xl font-black italic uppercase tracking-tighter leading-none text-white">AnÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½lisis del Negocio</h3><p className="text-[9px] md:text-[10px] text-indigo-400 font-black uppercase mt-2 italic tracking-[0.16em] md:tracking-[0.2em] leading-none">MÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½tricas avanzadas y rendimiento comercial real</p></div>
        <div className="flex flex-col sm:flex-row gap-3 sm:items-center">
          {(branches || []).length > 0 && (
            <div className="w-full sm:min-w-[220px] sm:w-auto">
              ...
              >
                <option value="all">Toda la barberÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½a</option>
                {branches.map((branch) => (
                  <option key={branch.id} value={branch.id}>{branch.name}</option>
                ))}
              </select>
        ...
        {reportTab === 'ventas' ? (
              ...
              <div className="bg-slate-900 neon-border-emerald p-5 md:p-10 rounded-[2rem] md:rounded-[3.5rem] shadow-2xl relative overflow-hidden group flex flex-col justify-between text-white">
                <div className="relative z-10 text-white">
                 ...
                 <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest italic leading-none">Ingreso Total del Negocio</p>
                  ...
                  <p className="text-[10px] text-slate-500 font-black mt-4 uppercase italic leading-none">Cortes + productos ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½ {salesRangeLabel}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-900 border border-slate-800 p-4 md:p-10 rounded-[2rem] md:rounded-[3.5rem] shadow-2xl relative text-white flex flex-col min-h-[420px] md:min-h-[550px]">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 md:gap-6 mb-6 md:mb-12 text-white">
                <div>
                  ...
                  <p className="text-[9px] md:text-[10px] text-slate-500 font-black uppercase italic mt-1 tracking-[0.14em] md:tracking-widest leading-none">HistÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½rico real de la semana en curso (Lunes - Domingo)</p>
                </div>
          ...
          <section className="space-y-12 text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-white">
               ...
               <div className="bg-slate-900 p-6 rounded-[2rem] border border-slate-800 flex flex-col gap-2 text-white"><p className="text-[9px] font-black text-slate-500 uppercase tracking-[0.2em] italic leading-none">Nivel SatisfacciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n</p><div className="flex items-end justify-between text-white"><h5 className="text-2xl font-black italic text-amber-500 leading-none">4.8 / 5.0</h5><div className="p-2 bg-amber-600/10 rounded-lg text-amber-500"><Star size={16} fill="currentColor"/></div></div></div>
               <div className="bg-slate-900 p-6 rounded-[2rem] border border-slate-800 flex flex-col gap-2 text-white"><p className="text-[9px] font-black text-slate-500 uppercase tracking-[0.2em] italic leading-none">Tasa de RetenciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n</p><div className="flex items-end justify-between text-white"><h5 className="text-2xl font-black italic text-emerald-400 leading-none">82%</h5><div className="p-2 bg-emerald-600/10 rounded-lg text-emerald-400"><UserCheck size={16}/></div></div></div>
              ...
              <div className="xl:col-span-2 bg-slate-900 border border-slate-800 p-10 rounded-[3.5rem] shadow-2xl relative text-white flex flex-col">
                      ...
                      <div className="flex flex-col sm:flex-row gap-2">
                        <div className="min-h-[52px] flex-1 px-4 py-3 rounded-2xl bg-indigo-600/15 border border-indigo-500/20 flex flex-col justify-center text-left">
                          ...
                          <span className="hidden text-[11px] font-black text-white leading-tight break-words">
                            {staffRangePreset === 'custom' ? 'Rango personalizado' : `Vista ${periodOptions.find((option) => option.id === staffRangePreset)?.label || 'Mes'}`} ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½ {staffRangeLabel}
                          </span>
                        </div>
                        <div className="flex gap-2">
                          <button
                ...
                <div className="relative z-10 mt-2 flex-1 overflow-x-hidden md:overflow-x-auto custom-scrollbar pb-3 px-1 md:px-0">
                  <div
                    ...
                    style={{ width: '100%' }}
                  >
                    {/* CUADRÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½CULA ESTRUCTURADA DE FONDO */}
                  ...
                  {stats.staffMetrics.map(b => (
                    <div key={b.id} className="bg-slate-900 border border-slate-800 p-8 rounded-[2.5rem] transition-all group relative overflow-hidden hover:border-indigo-500/50 text-white">
                       ...
                       <div className="grid grid-cols-2 gap-4 text-white">
                         ...
                         <div className="bg-black p-4 rounded-2xl border border-slate-800 text-white"><p className="text-[9px] font-black text-slate-500 uppercase italic leading-none">RetenciÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½n</p><p className="text-base font-black text-emerald-400 italic leading-none mt-2">{b.retention}%</p></div>
                       </div>
                    </div>
                  ))}
                </div>
...
const periodOptions = [{ id: 'week', label: 'Semana' }, { id: 'month', label: 'Mes' }, { id: 'year', label: 'AÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½o' }];
...
function ClientModal({ onClose, onSave, clients, initial }) {
  ...
  const handleSubmit = (e) => { 
    ...
    if (!isValidPhoneNumber(formattedPhone)) { setErrorMsg('El celular debe tener exactamente 8 dÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½gitos.'); return; }
    const duplicate = findClientByPhone(clients, formattedPhone, initial?.id);
    if (duplicate) { setErrorMsg(`Este nÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½mero ya pertenece a: ${duplicate.name}`); return; } 
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/90 backdrop-blur-xl animate-in fade-in text-white no-print">
      <div className="bg-slate-950 w-full max-w-lg rounded-[3rem] overflow-hidden shadow-2xl border border-slate-800 animate-in zoom-in-95 text-white">
        ...
        <form onSubmit={handleSubmit} className="p-10 space-y-8 text-white">
          ...
          <div className="space-y-3 text-white"><label className="text-[11px] font-black text-slate-500 uppercase italic leading-none">Notas TÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½cnicas</label><textarea placeholder="Ej. Piel sensible..." className="w-full bg-black border border-slate-800 rounded-3xl px-8 py-5 text-sm font-bold text-white min-h-[140px] outline-none focus:border-indigo-600 italic leading-relaxed" value={formData.notes} onChange={e => setFormData({...formData, notes: e.target.value})} /></div>
...
function AppointmentModal({ onClose, onSave, services, clients, barbers, initial, appointments }) {
  ...
  const handleSubmit = (e) => { 
    ...
    if ((selectedClient || isNewClient) && phoneVal.trim() && !isValidPhoneNumber(phoneVal)) { setModalError("El celular debe tener exactamente 8 dÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½gitos."); return; }
    if (isNewClient && !phoneVal.trim()) { setModalError("Ingresa el nÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½mero de celular del nuevo cliente."); return; }
    if (isNewClient && duplicatePhoneClient) { setModalError(`Ese nÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½mero ya estÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½ registrado con ${duplicatePhoneClient.name}.`); return; }
            ...
            <div className="space-y-4 text-white" ref={wrapperRef}>
              ...
              <div className="space-y-3 text-white relative">
                ...
                {(selectedClient || isNewClient) && (
                  <input required type="tel" className="w-full bg-black border-2 border-indigo-600/40 p-5 rounded-[1.2rem] text-sm font-black text-white italic leading-none" placeholder="TELÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½FONO 0000-0000" value={phoneVal} onChange={e => setPhoneVal(formatPhoneNumber(e.target.value))} />
                )}
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 gap-4 text-white">
                ...
                {form.type === 'walkin' ? (
                  <div className="w-full bg-indigo-600/10 border border-indigo-500/30 py-4 px-6 rounded-[1.2rem] flex items-center gap-2 text-white">
                    ...
                    <span className="text-[11px] font-black text-indigo-400 uppercase italic leading-none">Cola (Auto) ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â½ {form.time || '--:--'}</span>
                  </div>
                ) : (
