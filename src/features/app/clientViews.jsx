        ...
        <div className="flex flex-col md:flex-row text-white overflow-hidden">
          <div className="w-full md:w-[34%] bg-black p-5 md:p-8 border-b md:border-b-0 md:border-r border-slate-900 flex flex-col items-center text-center text-white md:overflow-visible overflow-y-auto custom-scrollbar">
            <div className="w-20 h-20 md:w-24 md:h-24 bg-indigo-600 rounded-[1.7rem] md:rounded-[2rem] flex items-center justify-center text-white shadow-2xl mb-4 relative text-white">
              <User size={46} /><div className={`absolute -bottom-1.5 -right-1.5 p-2.5 rounded-xl border shadow-lg ${stats.type.bg} ${stats.type.border} text-white`}><TypeIcon size={20} className={stats.type.color} /></div>
            </div>
            <div className={`border-2 px-5 md:px-6 py-2.5 rounded-2xl mb-3 ${stats.type.bg} ${stats.type.border} text-white`}><span className={`text-[10px] md:text-[11px] font-black uppercase italic tracking-[0.18em] ${stats.type.color}`}>CLIENTE {stats.type.label}</span></div>
            <h3 className="text-xl md:text-2xl font-black uppercase italic tracking-tighter mb-3 text-white leading-none break-words">{client.name}</h3>
            ...
            <div className="bg-slate-900 border px-4 py-2 rounded-xl mb-5 flex items-center gap-2 text-white"><CalendarCheck size={13} className="text-emerald-400" /><span className="text-[10px] font-black text-slate-300 uppercase italic leading-none">Última Visita: {stats.lastVisitDate}</span></div>

            <div className="w-full bg-slate-900/60 p-4 rounded-[1.5rem] border border-indigo-500/20 mb-4 text-white">
          ...
          <div className="flex-1 p-5 md:p-8 flex flex-col bg-slate-950/50 text-white overflow-hidden text-white">
            <div className="flex justify-between items-start mb-5 text-white">
              <div className="flex items-center gap-3 text-white">
                <Star size={23} className="text-amber-400 fill-amber-400" />
                <h4 className="text-lg md:text-xl font-black uppercase italic text-white tracking-tighter leading-none">DATOS DE LEALTAD</h4>
              </div>
            ...
            <div className="flex-1 space-y-4 overflow-y-auto custom-scrollbar pr-1">
              <div className="space-y-3">
                <div className="bg-slate-900/40 border border-slate-800 p-4 rounded-[1.8rem] flex items-center justify-between gap-4 group hover:border-indigo-500/30 transition-all">
                  ...
                  <span className="text-sm md:text-base font-black text-white uppercase italic tracking-tighter text-right">{stats.favService}</span>
                </div>
                ...
                <div className="bg-slate-900/40 border border-amber-500/20 p-4 rounded-[1.8rem] flex items-center justify-between gap-4 group hover:border-amber-500/40 transition-all">
                  ...
                  <span className="text-sm md:text-base font-black text-white uppercase italic tracking-tighter text-right">{stats.favBarber}</span>
                </div>
              </div>
              ...
              <div className="pt-3 space-y-3">
                ...
                <div className="bg-black/40 border border-white/5 p-5 rounded-[1.8rem] shadow-inner relative overflow-hidden group min-h-[96px]">
